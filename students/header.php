...
$students_login = $_SESSION['student_login'];

$result = mysqli_query($conn, "SELECT * FROM `students` WHERE `email`='$students_login' OR `username`='$students_login'");
                ...
                <div class="header-section" id="user-headerbox">
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            <ul>
                                <li> <a href="students_profile.php"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
