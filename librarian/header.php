...
$data = mysqli_query($conn,"SELECT * FROM `librarian` WHERE `username`='$librarian_login' OR `email`='$librarian_login'");
                ...
                <div class="header-section" id="user-headerbox">
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            <ul>
                                <li> <a href="librarian_profile.php"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="<?php echo $page == 'students.php' ? 'active-item':''?>"><a href="students.php"><i class="fa fa-users" aria-hidden="true"></i><span>Students</span></a></li>
                                <li class="has-child-item close-item <?php echo $page == 'add_books.php' ? 'open-item':'' ?><?php echo $page == 'manage_books.php' ? 'open-item':'' ?>">
                                    <a><i class="fa fa-book" aria-hidden="true"></i><span>Books</span></a>
                                    <ul class="nav child-nav level-1" style="">
                                        <li class="<?php echo $page == 'add_books.php' ? 'active-item':'' ?>" ><a href="add_books.php">Add Books</a></li>
                                        <li class="<?php echo $page == 'manage_books.php' ? 'active-item':'' ?>" ><a href="manage_books.php">Manage Books</a></li>
                                    </ul>
                                </li>
                                <li class="<?php echo $page == 'issue_books.php' ? 'active-item':''?>"><a href="issue_books.php"><i class="fa fa-book" aria-hidden="true"></i><span>Issue Book</span></a></li>
                                <li class="<?php echo $page == 'return_books.php' ? 'active-item':''?>"><a href="return_books.php"><i class="fa fa-book" aria-hidden="true"></i><span>Return Books</span></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
